...
string CADENAS[NUMERO_MENSAJES] = {
    "Afirmativo.",
    "Negativo.",
    ...
    Fecha Cuac::devolver_fecha(){
        return fecha;
    }

    bool Cuac::es_anterior(Cuac& c){
        Fecha comparar = c.devolver_fecha();
        return fecha.es_menor(comparar);
        //hago esto porque supongo que c.fecha es algo privado que no puedo acceder a.
    }
